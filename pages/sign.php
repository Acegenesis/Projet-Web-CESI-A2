...
<form id="form">
        ...
        <?php if($c != 0) : ?>
            <div>
                <input type=password class="formInput" placeholder="Confirm your password" required>
        ...
        <?php endif; ?>
        <a href="<?php echo ($c === 0) ? 'sign.php?type=up' : 'sign.php?type=in'?>" id="help"><?php echo ($c === 0) ? 'Créer un compte ?' :'Se connecter' ?></a>
        <button><?php echo ($c === 0) ? 'Se connecter' : 'Valider' ?></button>
    </form>
